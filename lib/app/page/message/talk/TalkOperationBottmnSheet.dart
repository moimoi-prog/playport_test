...
void showTalkOperationBottmnSheet(BuildContext context, String id, String opponent) async {
          ...
          children: <Widget>[
            ListTile(
                ...
                onTap: () async {
                  ...
                  // 画像をアップロード
                  uploadImage(file).then((path) => sendTalkImage(id, user.uid, opponent, path, "image", image.width, image.height));
