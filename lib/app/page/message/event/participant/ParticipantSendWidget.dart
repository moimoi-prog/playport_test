...
import 'ParticipantOperationBottmnSheet.dart';

class ParticipantSendWidget extends StatelessWidget {
  /* ルームID  */ final String id;

  final TextEditingController _messageController = TextEditingController();

  ParticipantSendWidget({Key key, this.id})
       : super(key: key);
      ...
      child: Row(
        ...
        children: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              showParticipantOperationBottmnSheet(context, id);
            },
          ),
          StreamBuilder(
