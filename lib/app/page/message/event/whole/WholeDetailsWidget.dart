...
class WholeDetailsWidget extends StatelessWidget {
  ...
  WholeDetailsWidget({Key key, this.id, this.create})
      : assert(id != null),
        super(key: key);
  ...
  Widget build(BuildContext context) {
    // クエリを生成
    Query query = FirebaseFirestore.instance.collection(Strings.EVENTS).doc(id).collection(Strings.MESSAGES).orderBy(Strings.TIMESTAMP, descending: false);
        ...
        child: SingleChildScrollView(
          ...
          child: StreamBuilder(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> message) {
                if (!message.hasData) {
                  return Text(Strings.MESSAGE_LOADING_MESSAGE);
                }
