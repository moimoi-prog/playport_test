...
void showWholeOperationBottmnSheet(BuildContext context, String id) async {
          ...
          children: <Widget>[
            ListTile(
                ...
                onTap: () async {
                  ...
                  // 画像をアップロード
                  uploadImage(file).then((path) => sendWholeImage(id, user.uid, path, "image", image.width, image.height));
