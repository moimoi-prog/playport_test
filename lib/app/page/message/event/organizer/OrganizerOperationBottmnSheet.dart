...
void showOrganizerOperationBottmnSheet(BuildContext context, String id, String opponent) async {
          ...
          children: <Widget>[
            ListTile(
                ...
                onTap: () async {
                  ...
                  // 画像をアップロード
                  uploadImage(file).then((path) => sendInquiryImage(id, user.uid, path, "image", image.width, image.height));
