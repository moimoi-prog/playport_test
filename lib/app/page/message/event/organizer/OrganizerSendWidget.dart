...
import 'OrganizerOperationBottmnSheet.dart';

class OrganizerSendWidget extends StatelessWidget {
  /* ルームID  */ final String id;
  /* 相手   　 */ final String opponent;

  final TextEditingController _messageController = TextEditingController();

  OrganizerSendWidget({Key key, this.id, this.opponent})
       : super(key: key);
      ...
      child: Row(
        ...
        children: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              showOrganizerOperationBottmnSheet(context, id, opponent);
            },
          ),
          StreamBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> doc) {
              ...
              return PopupMenuButton<String>(
                  ...
                  onSelected: (String value) async {
                    await sendInquiryMessage(id, user.uid, value, Strings.TEXT);
                  },
          ...
          IconButton(
              ...
              onPressed: () async {
                if (_messageController.text != null && _messageController.text != "") {
                  sendInquiryMessage(id, user.uid, _messageController.text, Strings.TEXT);
