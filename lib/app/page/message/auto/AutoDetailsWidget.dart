...
class AutoDetailsWidget extends StatelessWidget {
  ...
  AutoDetailsWidget({Key key, this.id, this.create})
      : assert(id != null),
        super(key: key);
  ...
  Widget build(BuildContext context) {
    // クエリを生成
    Query query = FirebaseFirestore.instance.collection(Strings.AUTOS).doc(id).collection(Strings.MESSAGES).orderBy(Strings.TIMESTAMP, descending: false);
