...
import 'AutoOperationBottmnSheet.dart';

class AutoSendWidget extends StatelessWidget {
  /* ルームID  */ final String id;
  /* 相手   　 */ final String opponent;

  final TextEditingController _messageController = TextEditingController();

  AutoSendWidget({Key key, this.id, this.opponent})
       : super(key: key);
      ...
      child: Row(
        ...
        children: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              showAutoOperationBottmnSheet(context, id, opponent);
            },
          ),
          StreamBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> doc) {
              ...
              return PopupMenuButton<String>(
                  ...
                  onSelected: (String value) async {
                    await sendAutoMessage(id, user.uid, opponent, value, Strings.TEXT);
                  },
          ...
          IconButton(
              ...
              onPressed: () async {
                if (_messageController.text != null && _messageController.text != "") {
                  sendAutoMessage(id, user.uid, opponent, _messageController.text, Strings.TEXT);
