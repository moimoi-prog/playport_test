...
// 参加イベントメッセージ明細
// ------------------------------------
class JoinEventMessageDetail extends StatelessWidget {
  /* Messageデータ */ final MessageDetail message;

  JoinEventMessageDetail({Key key, this.message}) : super(key: key);
      ...
      child: InkWell(
        onTap: () async {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) {
                return JoinEventMessageTabView(id: message.id, title: message.name);
              },
            ),
          );
        },
              ...
              children: <Widget>[
                ListTile(
                  ...
                  title: Row(
                    ...
                    children: <Widget>[
                      Text(message.name),
                      // Text("参加イベント", style: TextStyle(color: Colors.grey))
                    ],
                  ),
